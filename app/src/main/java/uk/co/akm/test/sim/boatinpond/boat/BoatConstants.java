...
public final class BoatConstants {
     ...
     */
    public BoatConstants(double v0, double frVFinal, double tv, double kLatOverKLon, double omgMax, double frOmgFinal, double tOmg) {
