 ...
 */
abstract class AbstractViewBoxTest {
    private final double accuracy = 0.000000000000001;

    @Test
    public void shouldBuildLines() {
        final ViewBoxFeatures underTest = buildViewBox(2, 5, 400, 400);
    ...
    public void shouldBuildMultipleLines() {
        final ViewBoxFeatures underTest = buildViewBox(3, 1, 400, 400);
    ...
    public void shouldBuildMultipleLinesWhenBoxIsNotSquared() {
        final ViewBoxFeatures underTest = buildViewBox(3, 1, 400, 800);
    ...
    public void shouldSetFixedPointAtTheOrigin() {
        ...
        final ViewBoxFeatures underTest = buildViewBox(env,2, 5, 400, 400);
    ...
    @Test
    public void shouldSetFixedPointAfterFastRotation() {
        final Environment env = new MockEnvironment(0, 0.5);
        final ViewBoxFeatures underTest = buildViewBox(env,2, 5, 400, 400);
    ...
    protected abstract ViewBoxFeatures buildViewBox(double horizontalSide, double lineSpacing, int screenWidth, int screenHeight);

    protected abstract ViewBoxFeatures buildViewBox(Environment environment, double horizontalSide, double lineSpacing, int screenWidth, int screenHeight);
