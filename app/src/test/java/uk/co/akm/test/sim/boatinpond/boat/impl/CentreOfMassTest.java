...
public class CentreOfMassTest {
    ...
    public void shouldCalculateCentreOfMass() {
        ...
        final double b = 1;
        final double f = 0.8;
        final SimpleBoatStructure underTest = new SimpleBoatStructure(l, b, dummyHeight, f, dummyMass);
    ...
    public void shouldCalculateCentreOfMassForDifferentBowSizes() {
        ...
        final double f1 = 0.8;
        final SimpleBoatStructure underTest1 = new SimpleBoatStructure(l, b, dummyHeight, f1, dummyMass);
        final double x1 = underTest1.getCentreOfMassFromStern();
        Assert.assertTrue(x1 < l/2);
        Assert.assertTrue(x1 > l*f1/2);

        final double f2 = 0.5;
        final SimpleBoatStructure underTest2 = new SimpleBoatStructure(l, b, dummyHeight, f2, dummyMass);
